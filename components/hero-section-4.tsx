                    ...
                    <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
                        <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl font-medium md:text-6xl lg:mt-16 xl:text-7xl">Building Smarter Businesses with Technology That Lasts</h1>
                                <p className="mt-8 max-w-2xl text-pretty text-lg">At Pripo Techlabs, we enable organizations to embrace digital transformation with precision-engineered software solutions. From custom applications to enterprise platforms, we design technology that drives efficiency, fosters innovation, and creates measurable business impact.</p>
